...
# SQL queries
Q1="SELECT * FROM spider_boxes WHERE ST_Intersects(geom, ST_GeomFromText('POLYGON((0.00 0.00,0.40 0.00,0.40 0.40,0.00 0.40,0.00 0.00))', 4326))"

Q2="SELECT * FROM spider_boxes a, spider_boxes_2 b WHERE ST_Intersects(a.geom, b.geom)"

Q3="SELECT * FROM spider_boxes a, spider_boxes_2 b WHERE ST_Intersects(a.geom, ST_GeomFromText('POLYGON((0.00 0.00,0.40 0.00,0.40 0.40,0.00 0.40,0.00 0.00))', 4326)) AND ST_Intersects(b.geom, ST_GeomFromText('POLYGON((0.00 0.00,0.20 0.00,0.20 0.20,0.00 0.20,0.00 0.00))', 4326)) AND ST_Intersects(a.geom, b.geom)"
