...
//        configuration.setProperty("wayang.postgres.jdbc.url", "jdbc:postgresql://cx32:5432/postgres"); // Default port 5432
//        configuration.setProperty("wayang.postgres.jdbc.user", "anton.persitzky");
